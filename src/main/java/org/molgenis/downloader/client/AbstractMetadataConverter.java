...
abstract class AbstractMetadataConverter implements MetadataConverter {
    ...
    <R> void setData(final Map<Attribute, String> data, final String field, Function<String, R> mapper, Consumer<R> consumer) {
        setData(data, field, (string -> !string.isEmpty()), mapper, consumer);
    }

    <R> void setList(final Map<Attribute, String> data, final String field, Function<String, R> mapper, Consumer<R> consumer) {
