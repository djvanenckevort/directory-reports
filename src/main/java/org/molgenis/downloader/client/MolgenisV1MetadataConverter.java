...
import org.molgenis.downloader.api.WritableMetadataRepository;
...
class MolgenisV1MetadataConverter extends AbstractMetadataConverter {
    ...
    private final WritableMetadataRepository repository;

    public MolgenisV1MetadataConverter(final WritableMetadataRepository metadataRepository) {
    ...
    public Attribute toAttribute(final Map<Attribute, String> data) {
        ...
        setBoolean(data, "aggregateable", att::setAggregatable);
